...
| R-017 | ObjectState 可能只是 observation slot，不是 persistent world state | 三段 BOP 当前重跑为 0 pass / 6 fail / 3 blocked；identity 全 fail、prediction 全 fail、action 全 blocked | 至少 3 个真实 controlled scenes 独立通过 identity/prediction/intervention 比较 | open / P0 |
