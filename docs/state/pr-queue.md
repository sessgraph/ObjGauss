...
| PR-01C Writer | `committed_local_supported_pending_remote` | commit `71d4e39`；22 Python tests；同一 clean source 下 canonical/reverse evidence 一致；每 branch 111 trajectory / 110 contact records | 最终 SHA 远端 CI |
...
| PR-01F Delivery | `committed_local_supported_pending_remote` | 最终 clean HEAD 的 `accept-pr01` supported；1210 checksum entries；source commit 绑定 HEAD | 最终 SHA 远端 CI |
