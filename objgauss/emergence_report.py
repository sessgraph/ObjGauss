...
def _method_note(curves: Sequence[EmergenceCurveInput]) -> str:
    ...
    return (
        ...
        "deterministic CPU splat renders in image space. The current probe uses "
        "Gaussian scale and opacity for a small footprint, but is not a full "
        "covariance-aware training renderer. "
