...
from objgauss.core.objects import assign_object_ids

_EPS = 1e-8
_FIELD_VERSION = 1
_COMPAT_EXPORTS = {
    "NerfDatasetSummary": ("objgauss.datasets.nerf_inspection", "NerfDatasetSummary"),
    "NerfSplitSummary": ("objgauss.datasets.nerf_inspection", "NerfSplitSummary"),
    "inspect_nerf_dataset": ("objgauss.datasets.nerf_inspection", "inspect_nerf_dataset"),
    "write_json": ("objgauss.pipelines.json_io", "write_json"),
}
