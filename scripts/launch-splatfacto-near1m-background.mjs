...
const commonCandidateOptions = [
  ...
  ...optionalPair("--output-root", args.outputRoot),
  ...optionalPair("--experiment", args.experiment),
  ...optionalPair("--timestamp", args.timestamp),
  ...optionalPair("--export-dir", args.exportDir),
  ...optionalPair("--object-field-dir", args.objectFieldDir),
  ...optionalPair("--candidate-output-dir", args.candidateOutputDir),
  ...optionalPair("--benchmark-output-dir", args.benchmarkOutputDir),
  ...optionalPair("--sla-output-dir", args.slaOutputDir),
  ...optionalPair("--asset-id", args.assetId),
  ...optionalPair("--public-name", args.publicName),
  ...optionalPair("--label", args.label),
  ...optionalPair("--sam-checkpoint", args.samCheckpoint),
  ...optionalPair("--sam-manifest", args.samManifest),
  ...optionalPair("--iterations", args.iterations),
  ...optionalPair("--steps-per-save", args.stepsPerSave),
  ...optionalPair("--cache-images", args.cacheImages),
  ...optionalPair("--camera-res-scale-factor", args.cameraResScaleFactor),
  ...optionalPair("--images-on-gpu", args.imagesOnGpu),
  ...optionalPair("--masks-on-gpu", args.masksOnGpu),
  ...optionalPair("--random-init", args.randomInit),
  ...optionalPair("--num-random", args.numRandom),
  ...optionalPair("--random-scale", args.randomScale),
  ...optionalPair("--warmup-length", args.warmupLength),
  ...optionalPair("--refine-every", args.refineEvery),
  ...optionalPair("--reset-alpha-every", args.resetAlphaEvery),
  ...optionalPair("--densify-grad-thresh", args.densifyGradThresh),
  ...optionalPair("--densify-size-thresh", args.densifySizeThresh),
  ...optionalPair("--n-split-samples", args.nSplitSamples),
  ...optionalPair("--cull-alpha-thresh", args.cullAlphaThresh),
  ...optionalPair("--cull-scale-thresh", args.cullScaleThresh),
  ...optionalPair("--cull-screen-size", args.cullScreenSize),
  ...optionalPair("--split-screen-size", args.splitScreenSize),
  ...optionalPair("--stop-screen-size-at", args.stopScreenSizeAt),
  ...optionalPair("--stop-split-at", args.stopSplitAt),
  ...optionalPair("--num-downscales", args.numDownscales),
