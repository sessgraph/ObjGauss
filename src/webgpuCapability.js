...
export function editRendererContract(webGpuCapability, tileSmoke) {
  ...
  return {
    ...
    colorTuningMode: smoke.colorTuningMode,
    colorMode: smoke.colorMode,
    ...
    colorShRestGaussians: smoke.colorShRestGaussians,
    colorShRestCoefficientMax: smoke.colorShRestCoefficientMax,
    colorShDegreeMax: smoke.colorShDegreeMax,
    colorShViewGaussians: smoke.colorShViewGaussians,
