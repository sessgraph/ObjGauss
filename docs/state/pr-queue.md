...
| PR-02C Trainer/Baselines | `c3_committed_local_supported` | C0 `fc20023`、C1 `adb1a62`、C2 `9ea2b92` clean supported；C3 `4498bd6` clean gate 重建 60 groups / 300 branches / 120 baseline predictions，CPU tiny 与 GPU golden 24/24 checks supported，semantic index `709f6f76…d3db`，mutation/test split 被拒绝 | 无远端 CI；下一门 C6 只运行冻结的 24-task HPO/config selection，不读取 final test；尚未开始 |
