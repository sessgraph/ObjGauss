...
| PR-02C Trainer/Baselines | `c2_committed_local_supported` | C0 `fc20023` clean supported；C1 `adb1a62` clean supported；C2 `9ea2b92` clean gate 重建 60 groups / 300 branches / 0 failures，发布 120 predictions，18 checks、repeat、mutation 与 checksums supported；data index `970b9359…2e745`，semantic index `17488a15…7c647` | 无远端 CI；下一片 C3 只实现两个 learned arms、trainer、lineage 与 golden repeat，不运行 HPO/formal test |
