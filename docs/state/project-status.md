...
1. RENDER-005Q: 在 WebGPU-capable 桌面 Chrome 中重跑 clear-only / texture-display / full runtime audit；若桌面 pass，将当前问题正式归类为 headless unsafe WebGPU presentation limitation，并保留 compute/readback probes 作为 CI 可跑证据。
