...
| 当前未提交 snapshot/action/PR-01A–F worktree 的提交边界 | open | Owner 动作级 commit 授权与范围复核；提交后从 clean HEAD 重建全部 lineage | PR-01A / PR-01B / PR-01C / PR-01D / PR-01E / PR-01F |
| PR-01 最终 SHA 验收 | open | clean checkout 的 `./scripts/accept-pr01` supported，随后相同 SHA 的远端 delivery job supported | PR-01F |
