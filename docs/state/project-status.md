...
- 前端:
  ...
  - RENDER-005F 已落地 WebGPU covariance-aware tile sampling：accumulation shader 消费 Gaussian scale / rotation，并在 tile 内 2x2 sample points 上近似椭圆高斯 footprint；当前仍未实现 viewport-sized per-pixel accumulation buffer。
